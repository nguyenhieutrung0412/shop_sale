                ...
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row g-4"> <!--begin::Col-->
                        ...
                        <div class="col-md-12"> <!--begin::Quick Example-->
                            <form method="POST" action="{{ route('admin.categories.add.post') }}">
                                ...
                                <div class="card card-success card-outline mb-4"> <!--begin::Header-->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="input-group mb-3"> <span class="input-group-text" id="basic-addon1">Tên
                                                phân loại: </span> <input type="text" name="name" class="form-control"
                                                placeholder="Tên phân loại" aria-label="name"
